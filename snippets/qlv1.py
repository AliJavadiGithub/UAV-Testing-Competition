...
class QLearningGenerator(object):
    ...
    def calculate_reward(self, test):
        ...
        # Calculate the reward based on min_dist
        if min_dist < 0.25:
            return 5
    ...
    def generate(self, budget: int) -> List[TestCase]:
        ...
        for _ in range(budget):
            ...
            try:
                ...
                reward = self.calculate_reward(test) 
...
if __name__ == "__main__":
    generator = QLearningGenerator("case_studies/mission1.yaml")
